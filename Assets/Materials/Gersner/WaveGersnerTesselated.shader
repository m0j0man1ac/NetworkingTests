Shader"Ocean/WaveGersnerTesselated"
{
    Properties{
        //regular mat properties
        ...
        _WaveB ("Wave B (dir (2D), steepness, wavelength)", Vector) = (1,0,0.5,10)
        _WaveC ("Wave C (dir (2D), steepness, wavelength)", Vector) = (1,0,0.5,10)
        //_WaveDirection("Direction (2D)", Vector) = (1,0,0,0)
        ////_WaveSpeed("Wave Speed", float) = 1
        //_Wavelength("Wavelength", float) = 10
        ////_WaveAmplitude("Wave Amplitude", float) = 1
        //_Steepness("Wave Steepness", Range(0,1)) = .5
        _WaveGravity("Wave Gravity", float) = 9.8
        _WaveHorizontalStrength("Wave Horizontal Strength", float) = 1
        _WaveVerticalStrength("Wave Vertical Strength", float) = 1
    }
    SubShader{
        ...
        Pass 
        {
            ...
            #include "WaveGerserWithTesselation.hlsl"
            ENDHLSL
        }
    }
}
